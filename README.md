...
1.  ### ما هو React؟
    ...
    React (المعروف أيضًا بـ React.js أو ReactJS) هو **مكتبة جافا سكريبت مفتوحة المصدر** تُستخدم لبناء واجهات مستخدم قابلة لإعادة الاستخدام، خاصة لتطبيقات الصفحة الواحدة. تُستخدم React لإدارة طبقة العرض في تطبيقات الويب والهاتف المحمول استنادًا إلى المكونات بطريقة إعلانية.

    تم إنشاء React بواسطة [جوردان والكي](https://github.com/jordwalke)، وهو مهندس برمجيات يعمل لدى فيسبوك. تم نشر React لأول مرة في موجز أخبار فيسبوك في عام 2011 وعلى إنستجرام في عام 2012.
